<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/inicio_nq.css">    
    <title>MENU DP</title>
  </head>
  ...
  <body>
    <div class="contenedor"> 
      ...
      <div class="header"> 
        ...
        <div id="img"><a href="nequi?accion=index">
            <img src='
      ...
      <div class="centro">
        <div class="grid-container"> 
          ...
          <div class="grid-item"><a href="nequi?accion=recargar"><span style="color: #FFF;font-size:larger;font-family:'Arial';">RECARGAR</span></a> <br> <a href="nequi?accion=recargar"><img id="img2" src="assets/images/recargar.png"></a>
              </div> 
                <!-- imagen con el refferencia de ruta del servlet  " consultar saldo "-->
          <div class="grid-item"><a href="nequi?accion=consultar_saldo"><span style="color: #FFF;font-size:larger;font-family:'Arial';"> CONSULTAR
              SALDO</span></a><br> <a href="nequi?accion=consultar_saldo"> <img id="img1"
                src="assets/images/consultar_saldo1.png"></a></div>
                  <!-- imagen con el refferencia de ruta del servlet  " retirar deinero "-->
          <div class="grid-item">  <a href="nequi?accion=retirar"><span style="color: #FFF;font-size:larger;font-family:'Arial';">RETIRAR</span></a><br> 
            <a href="nequi?accion=retirar"><img id="img3" src="assets/images/retirar_dinero.png"></a></div>
        </div>
      </div>
    </div>
