<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/css/recarga.css">
        <title>Recarga Daviplata</title>
    </head>
    ...
    <body>
            ...
            <div class="centro ">
                <div class="grid">
                    ...
                    <div class="item"> <a class="a1" href="daviplata?accion=inicio_dp">MENU</a> </div>
                     <!-- division de grid con ruta de servlet con la accion de retiarar ( redirige a la vista recagar.jsp en el servlet  )  -->
                    <div class="item"> <a class="a1" href="daviplata?accion=retirar">SACAR DINERO</a> </div>
                    ...
                    <div class="item"> <a class="a1" href="daviplata?accion=consultar_saldo"> CONSULTAR SALDO</a> </div>
                </div>
            </div> 
